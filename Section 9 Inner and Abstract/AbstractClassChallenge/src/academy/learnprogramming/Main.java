...
//        for (String s : data) {
    ...
    public static void main(String[] args) {
        String stringData = "Darwin Brisbane Perth Melbourne Canberra Adelaide Sydney Canberra";
//        String stringData = "Brisbane Darwin Darwin Perth Canberra Adelaide";

        MyLinkedList<String> myList = new MyLinkedList<>(null);
        String[] data = stringData.split(" ");
        for (String s : data) {
            myList.addItem(new Node<String>(s));
        }
        ...
        myList.removeItem(new Node<String>("Sydney"));
