...
//NOTE: Do not add a main method to the solution code.
    ...
    public static void main(String[] args) {
        ...
        System.out.println("A circle with radius " + cylinder.getRadius() + " has an area of " + cylinder.getArea());
        System.out.println("A cylinder with radius " + cylinder.getRadius() + " and height " + cylinder.getHeight() + " has an area of " + cylinder.getArea() + " and volume " + cylinder.getVolume());
