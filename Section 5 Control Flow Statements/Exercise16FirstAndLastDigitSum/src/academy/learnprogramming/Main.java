...
//NOTE: Do not add a  main method to solution code.
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Sum of first and last digit of -252 is " + FirstLastDigitSum.sumFirstAndLastDigit(-252));

        System.out.println("Sum of first and last digit of 252 is " + FirstLastDigitSum.sumFirstAndLastDigit(252));
        System.out.println("Sum of first and last digit of 257 is " + FirstLastDigitSum.sumFirstAndLastDigit(257));
        System.out.println("Sum of first and last digit of 0 is " + FirstLastDigitSum.sumFirstAndLastDigit(0));
        System.out.println("Sum of first and last digit of 5 is " + FirstLastDigitSum.sumFirstAndLastDigit(5));
        System.out.println("Sum of first and last digit of -10 is " + FirstLastDigitSum.sumFirstAndLastDigit(-10));
    }
}
