...
//NOTE: Do not add a main method to solution code.
    ...
    public static void main(String[] args) {
        ...
        System.out.println("isLeapYear(-1600) = " + NumberOfDaysInMonth.isLeapYear(-1600));
        System.out.println("isLeapYear(1600) = " + NumberOfDaysInMonth.isLeapYear(1600));
        System.out.println("isLeapYear(2017) = " + NumberOfDaysInMonth.isLeapYear(2017));
        System.out.println("isLeapYear(2000) = " + NumberOfDaysInMonth.isLeapYear(2000));
