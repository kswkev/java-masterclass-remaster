...
//NOTE: Do not add the main method to the solution code.
    ...
    public static void main(String[] args) {
        ...
        System.out.println("getBucketCount(-1.0, 2.0) = " + PaintJob.getBucketCount(-1.0, 2.0));
        System.out.println("getBucketCount(1.0, -2.0) = " + PaintJob.getBucketCount(1.0, -2.0));
        ...
        System.out.println("getBucketCount(3.26, 0.75) = " + PaintJob.getBucketCount(3.26, 0.75));

        System.out.println("getBucketCount(-3.4, 2.1, 1.5, 2) = " + PaintJob.getBucketCount(-3.4, 2.1, 1.5, 2));
        System.out.println("getBucketCount(3.4, 2.1, 1.5, 2) = " + PaintJob.getBucketCount(3.4, 2.1, 1.5, 2));
        System.out.println("getBucketCount(2.75, 3.25, 2.5, 1) = " + PaintJob.getBucketCount(2.75, 3.25, 2.5, 1));

        System.out.println("getBucketCount(-3.4, 2.1, 1.5) = " + PaintJob.getBucketCount(-3.4, 2.1, 1.5));
        System.out.println("getBucketCount(3.4, 2.1, 1.5) = " + PaintJob.getBucketCount(3.4, 2.1, 1.5));
        System.out.println("getBucketCount(7.25, 4.3, 2.35) = " + PaintJob.getBucketCount(7.25, 4.3, 2.35));
